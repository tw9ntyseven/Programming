...
int main() {
    ...
    auto openweather_res = openweather_cli.Get("/data/2.5/onecall?id=eff249724eb9589a6c6a62e8dfb5578f&lang=ru&units=metric&lat=44.95719&lon=34.11079&exclude=current,minutely,daily,alerts");

    // get json weather
    json openweather_json;
    json_init(openweather_res, openweather_json);
 
    // take worldtime with api
